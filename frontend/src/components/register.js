...
function Registration(){
    ...
    return(
        ...
        <Radio sx={{ ml: 13 ,mb:1}} type="radio" name="userType" value="Buyer"  id="Buyer" checked={userType === "Buyer"} onChange={changesInputValues}/>
        ...
        <TextField required  label= "First Name" sx={{ ml: 12  }}  size='small'type="text" name="firstName" value={firstName} onChange={changesInputValues}/><br>
        </br>
        ...
        <TextField   required label= "Last Name" sx={{ ml: 12  }} size='small'  type="text" name="lastName"  value={lastName} onChange={changesInputValues}/>
        <p style={{color:"Red",textAlign:"center"}}>
                    {errorMessageforLastName}
        </p>

          {/* <InputLabel  required sx={{ ml: 10  }} className="label"><b>Email</b></InputLabel> */}
        <TextField  required label="Email Address" sx={{ ml: 12  }}  size='small'type="text" name="email"  value={email} onChange={changesInputValues}/>
        <p style={{color:"Red",textAlign:"center"}}>
                    {errorMessageforEmail}
        </p>

        {/* <InputLabel  required sx={{ ml: 10  }} className="label"><b>Password</b></InputLabel> */}
        <TextField   required label="Password" sx={{ ml: 12 }}  size='small' type="password" name="password"  value={password} onChange={changesInputValues}/>
        <p style={{color:"Red",textAlign:"center"}}>
                    {errorMessageforPassword}
        </p>

        {/* <InputLabel  required sx={{ ml: 10  }} className="label"><b>Confirm Password</b></InputLabel> */}
        <TextField   required label="Confirm Password"sx={{ ml: 12  }}  size='small' type="password" name="confirmpassword"  value={confirmPassword} onChange={changesInputValues}/>
        <p style={{color:"Red",textAlign:"center"}}>
