...
function OTP(){
    ...
    const send=(e)=>{
      ...
      const data={
        ...
        axios.post(process.env.REACT_APP_BACKEND_SERVER+"/user/otp", data)
        .then(response =>{
    ...
    return(
        ...
        <Radio sx={{ ml: 10  ,mb:1}}  type="radio" name="userType" value="Buyer"  id="Buyer" checked={userType === "Buyer"} onChange={changesInputValues}/>
        ...
        <TextField    label="Email Address" sx={{ ml: 10 ,mb:1 }} margin="normal"     type="text" name="email"  value={email} onChange={changesInputValues}/>
        <p style={{color:"Red",textAlign:"center" }}>
                    {errorMessageforEmail}
        </p>
        
        {/* <InputLabel required sx={{ ml: 10  }} className="label"><b>Email</b></InputLabel> */}
        <TextField    label="Enter OTP" sx={{ ml: 10 ,mb:1 }} margin="normal"     type="text" name="otp"  value={otp} onChange={changesInputValues}/>
        <p style={{color:"Red",textAlign:"center" }}>
                    {errorMessageforOTP}
        </p>
